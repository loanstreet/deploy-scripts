...
PROJECT_FILES_DIR=reactjs-project
...
cd $TEST_WORKING_DIR/reactjs-deploy-test/default/current
...
node tmp-webserver.js $TEST_WORKING_DIR/reactjs-deploy-test/default/current &
# npm run dev-server &
sleep 6
